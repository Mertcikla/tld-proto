...
const (
	...
	NotificationServiceName = "diag.v1.NotificationService"
)
...
const (
	...
	NotificationServiceListNotificationsProcedure = "/diag.v1.NotificationService/ListNotifications"
	// NotificationServiceMarkReadProcedure is the fully-qualified name of the NotificationService's
	// MarkRead RPC.
	NotificationServiceMarkReadProcedure = "/diag.v1.NotificationService/MarkRead"
	// NotificationServiceMarkAllReadProcedure is the fully-qualified name of the NotificationService's
	// MarkAllRead RPC.
	NotificationServiceMarkAllReadProcedure = "/diag.v1.NotificationService/MarkAllRead"
)

// NotificationServiceClient is a client for the diag.v1.NotificationService service.
type NotificationServiceClient interface {
	...
	MarkRead(context.Context, *connect.Request[v1.MarkNotificationReadRequest]) (*connect.Response[v1.MarkNotificationReadResponse], error)
	MarkAllRead(context.Context, *connect.Request[v1.MarkAllNotificationsReadRequest]) (*connect.Response[v1.MarkAllNotificationsReadResponse], error)
}

// NewNotificationServiceClient constructs a client for the diag.v1.NotificationService service. By
...
func NewNotificationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NotificationServiceClient {
	...
	notificationServiceMethods := v1.File_diag_v1_notification_service_proto.Services().ByName("NotificationService").Methods()
	return &notificationServiceClient{
		...
		markRead: connect.NewClient[v1.MarkNotificationReadRequest, v1.MarkNotificationReadResponse](
			httpClient,
			baseURL+NotificationServiceMarkReadProcedure,
			connect.WithSchema(notificationServiceMethods.ByName("MarkRead")),
			connect.WithClientOptions(opts...),
		),
		markAllRead: connect.NewClient[v1.MarkAllNotificationsReadRequest, v1.MarkAllNotificationsReadResponse](
			httpClient,
...
type notificationServiceClient struct {
	...
	markRead          *connect.Client[v1.MarkNotificationReadRequest, v1.MarkNotificationReadResponse]
	markAllRead       *connect.Client[v1.MarkAllNotificationsReadRequest, v1.MarkAllNotificationsReadResponse]
}

// ListNotifications calls diag.v1.NotificationService.ListNotifications.
...
// MarkRead calls diag.v1.NotificationService.MarkRead.
func (c *notificationServiceClient) MarkRead(ctx context.Context, req *connect.Request[v1.MarkNotificationReadRequest]) (*connect.Response[v1.MarkNotificationReadResponse], error) {
	return c.markRead.CallUnary(ctx, req)
}

// MarkAllRead calls diag.v1.NotificationService.MarkAllRead.
func (c *notificationServiceClient) MarkAllRead(ctx context.Context, req *connect.Request[v1.MarkAllNotificationsReadRequest]) (*connect.Response[v1.MarkAllNotificationsReadResponse], error) {
	return c.markAllRead.CallUnary(ctx, req)
}

// NotificationServiceHandler is an implementation of the diag.v1.NotificationService service.
...
func NewNotificationServiceHandler(svc NotificationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/diag.v1.NotificationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotificationServiceHandler) ListNotifications(context.Context, *connect.Request[v1.ListNotificationsRequest]) (*connect.Response[v1.ListNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("diag.v1.NotificationService.ListNotifications is not implemented"))
}

func (UnimplementedNotificationServiceHandler) MarkRead(context.Context, *connect.Request[v1.MarkNotificationReadRequest]) (*connect.Response[v1.MarkNotificationReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("diag.v1.NotificationService.MarkRead is not implemented"))
}

func (UnimplementedNotificationServiceHandler) MarkAllRead(context.Context, *connect.Request[v1.MarkAllNotificationsReadRequest]) (*connect.Response[v1.MarkAllNotificationsReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("diag.v1.NotificationService.MarkAllRead is not implemented"))
}
